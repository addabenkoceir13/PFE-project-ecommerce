<!-- Top navigation-->
<nav class="navbar navbar-expand-lg navbar-light bg-w border-bottom">
            ...
            <ul class="navbar-nav ms-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item dropdown">
                    <a href="#" class="d-flex align-items-center justify-content-center p-2 link-dark text-decoration-none dropdown-toggle" id="dropdownUser3" data-bs-toggle="dropdown" aria-expanded="false">
                        {{ Auth::user()->name }} <img class="mx-1" src="https://github.com/mdo.png" alt="mdo" width="24" height="24" class="rounded-circle">
                    </a>
